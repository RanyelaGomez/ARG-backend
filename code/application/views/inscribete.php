            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 Contenedor-General">
                    ...
                    <div class="formulario">
                      <form action="<?= site_url('principal/inscribir')?>" method="POST">
                              <div class="container">
                                  ...
                                  <div class="row form-inscrib">
                                        ...
                                        <div class="col-xs-9 col-sm-9 col-md-9">
                                            <input type="text" name="apellido" required="required" id="family-name">
                                        </div>
                                  </div>
                                  ...
                                  <div class="row form-inscrib">
                                        ...
                                        <div class="col-xs-9 col-sm-9 col-md-9">
                                            <input type="email" name="email1" required="required" id="email2">
                                        </div>
                                  </div>
